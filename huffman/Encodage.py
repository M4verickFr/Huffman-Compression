class Encodage():
    ...
    def make_table(self, node, code = ""):
        ...
        Args:
            node (Node): The node is the root node in the first iteration, and after that it is a child node until it reaches a leaf.
            code (str, optional): Defaults to "" in first iteration, and is completed by 0 or 1 at each iteration.
